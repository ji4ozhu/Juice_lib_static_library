...
// NAT traversal status - Get STUN mapped addresses
// Returns the count of STUN mapped addresses (0 if NAT traversal failed)
// If addresses is not NULL, fills up to max_count addresses
JUICE_EXPORT int juice_get_stun_mapped_addresses(juice_agent_t *agent, char *addresses, 
                                                  size_t address_size, int max_count);

// Get all local candidates (including IPv4 and IPv6 host addresses)
// Returns the count of local candidates
JUICE_EXPORT int juice_get_all_candidates(juice_agent_t *agent, char *addresses,
                                          size_t address_size, int max_count);
